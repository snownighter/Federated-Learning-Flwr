...
if __name__ == "__main__":
    ...
    X_t0, X_t1, y_t0, y_t1 = train_test_split(X_t0, y_t0, test_size=0.6, random_state=42)
    X_t2, X_t3, y_t2, y_t3 = train_test_split(X_t0, y_t0, test_size=0.25, random_state=42)
